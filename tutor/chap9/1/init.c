...
//        is (320 x 256). This is the games starting screen.
//--------------------------------------------------------------------------
...
// Returns: none
// Notes: 2 sprites are used since max tpage is (256 x 256) and our screen
//        is (320 x 256).  This is the game complete image.
//--------------------------------------------------------------------------
...
// Returns: none
// Notes: 2 sprites are used since max tpage is (256 x 256) and our screen
//        is (320 x 256).  This is the games story screen
//--------------------------------------------------------------------------
...
// Returns: none
// Notes: 2 sprites are used since max tpage is (256 x 256) and our screen
//        is (320 x 256).  This is the game over screen.
//-------------------------------------------------------------------------- 
...
//--------------------------------------------------------------------------
// Function: InitPlayer()
// Description: Read TIM, get tpage and set sprite structure.
// Parameters: none
// Returns: none
// Notes: N/A
//--------------------------------------------------------------------------
