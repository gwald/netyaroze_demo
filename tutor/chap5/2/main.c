...
// Author: George Bain
// Date: July 21, 1998
// Description: Chapter 5: Timer Example 2 - Our Clock
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Timer Example 2 - Our Clock 
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
...
int main( void )
 {
    ...
    while( !DONE )
      {	 		 	     
		 ...
		 FntPrint(fnt_id[0], "~c900Timer Example 2 - Our Clock");
		 FntPrint(fnt_id[1], "~c990%d:%d",
		         ((v_count/3000)%60), /* minutes */
		         ((v_count/50)%60));  /* seconds */	 
...
void InitGame( void )
 {
	 ...
	 fnt_id[0] = FntOpen(5,10,SCREEN_WIDTH, SCREEN_HEIGHT,0,80);
	 fnt_id[1] = FntOpen(5,20,SCREEN_WIDTH, SCREEN_HEIGHT,0,80);
	 fnt_id[2] = FntOpen(5,30,SCREEN_WIDTH, SCREEN_HEIGHT,0,80);
	 fnt_id[3] = FntOpen(5,40,SCREEN_WIDTH, SCREEN_HEIGHT,0,80);
