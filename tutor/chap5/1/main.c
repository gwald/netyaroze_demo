...
// Author: George Bain
// Date: July 21, 1998
// Description: Chapter 5: Timer Example 1 - Using Root Counters
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Timer Example 1 - Using Root Counters 
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		 ...
		 FntPrint(fnt_id[0], "~c900Timer Example 1 - Using Root Counters");
		 FntPrint(fnt_id[1], "~c900Value of root counter:%d",GetRCnt(1));
		 FntPrint(fnt_id[2], "~c900An event as occured :%d times",count);
