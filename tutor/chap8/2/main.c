...
// Author: George Bain
// Date: July 17, 1998
// Description: Chapter 8: A.I. Example 2 - Bounce 
...
int speed_x;						// x velocity
int speed_y;						// y velocity

//--------------------------------------------------------------------------
// Function: main()
// Description: A.I. Example 2 - Bounce
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		...
		FntPrint(fnt_id[0], "~c900A.I. Example 2 - Bounce");
...
//--------------------------------------------------------------------------
// Function: Bounce()
// Description: Bounce the box around the screen.  Checks for collision!
// Parameters: none
// Returns: none
// Notes: N/A
//--------------------------------------------------------------------------
