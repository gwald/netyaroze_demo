...
// Author: George Bain
// Date: July 20, 1998
// Description: Chapter 8: A.I. Example 7 - Wave Attack! 
...
//--------------------------------------------------------------------------
// Function: main()
// Description: A.I. Example 7 - Wave Attack!
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		...
		FntPrint(fnt_id[0], "~c900A.I. Example 7 - Wave Attack");
		FntPrint(fnt_id[1], "~c990Look out!  Box Attack!");	
			
		count++;
  	   	
		// move sprite
  	   	box.x = (rsin(50*count) / 137)+ 140;
		box.y += count % 2;
...
void InitBoxSprite( void )
 {	 	
	...
	InitSprite( &box,(1<<24),0,0,44,38,tpage,0,24,tim->cx,tim->cy,
