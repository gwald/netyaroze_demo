...
// Author: George Bain
// Date: July 17, 1998
// Description: Chapter 8: A.I. Example 3 - Random Direction
...
//--------------------------------------------------------------------------
// Function: main()
// Description: A.I. Example 3 - Random Direction
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		...
		FntPrint(fnt_id[0], "~c900A.I. Example 3 - Random Pattern 1");
		FntPrint(fnt_id[1], "~c900When collision has occured");
...
// Description: Move sprite around screen until a collision occurs against
//              boundry. If a collision occurs a new random direction will
//          	take effect.
// Parameters: none
// Returns: none
// Notes: N/A
...
void InitBoxSprite( void )
 {	 	
	...
	InitSprite( &box,(1<<24),50,50,44,22,tpage,0,0,tim->cx,tim->cy,
