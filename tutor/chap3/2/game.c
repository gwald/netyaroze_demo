...
void InitGame( void )
 {
	 ...
	 // max 8 streams can be opened at once
	 fnt_id[0] = FntOpen(0,10,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);
	 fnt_id[1] = FntOpen(0,30,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);
	 fnt_id[2] = FntOpen(0,40,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);
	 fnt_id[3] = FntOpen(0,50,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);

	 fnt_id[4] = FntOpen(0,70,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);
	 fnt_id[5] = FntOpen(0,80,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);
	 fnt_id[6] = FntOpen(0,90,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);
	 fnt_id[7] = FntOpen(0,150,SCREEN_WIDTH, SCREEN_HEIGHT,0,100);
...
void UpdateScreen( void )
 {
    ...
    vsync_count = VSync(0);    // 0: blocking until vertical synch occurs
