...
// Author: George Bain
// Date: July 16, 1998
// Description: Chapter 4: Collision Detecting Example 2 - Bounding Spheres
...
GsSPRITE circle, circle2;		    // our sprites	

//--------------------------------------------------------------------------
// Function: main()
// Description: Collision Detecting Example 2 - Bounding Spheres
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		...
		FntPrint(fnt_id[0], "~c900Collision Detecting Example 2");
