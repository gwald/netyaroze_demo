...
// Author: George Bain
// Date: July 15, 1998
// Description: Chapter 4: Collision Detecting Example 1 - Bounding Boxes 
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Collision Detecting Example 1 - Bounding Boxes
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		...
		FntPrint(fnt_id[0], "~c900Collision Detecting Example 1");
		FntPrint(fnt_id[1], "~c900-Bounding Boxes-"); 
