...
// Author: George Bain
// Date: July 19, 1998
// Description: Chapter 7: Scrolling Example 5 - Horizontal Star Field
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Scrolling Example 5 - Horizontal Star Field
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		 ...
		 FntPrint(fnt_id[0], "~c900Scrolling Example 5");
