...
// Author: George Bain
// Date: July 14, 1998
// Description: Chapter 7: Scrolling Example 4 - Tile Scrolling 
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Scrolling Example 4 - Tile Scrolling
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		 ...
		 FntPrint(fnt_id[0], "~c000Scrolling Example 4 - Tile Scrolling");
