...
// Author: George Bain
// Date: July 12, 1998
// Description: Chapter 7: Scrolling Example 1 - Horizontal Scrolling
...
short scroll_counter=0;				// scroll counter.

//--------------------------------------------------------------------------
// Function: main()
// Description: Scrolling Example 1 - Horizontal Scrolling
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		 ...
		 FntPrint(fnt_id[0], "~c900Scrolling Example 1 - Horizontal Scrolling");
...
// Description: Change x position of sprite based on our scroll counter and
...
void DrawBackground( void )
 {
	...
	left_screen.x = scroll_counter;
	GsSortFastSprite( &left_screen, &world_ordering_table[output_buffer_index], 0 );
	
	right_screen.x = scroll_counter + (SCREEN_WIDTH/2);
	GsSortFastSprite( &right_screen, &world_ordering_table[output_buffer_index], 0 );
	
	left_screen.x = scroll_counter + SCREEN_WIDTH;
	GsSortFastSprite( &left_screen, &world_ordering_table[output_buffer_index], 0 );
	
	right_screen.x = scroll_counter + SCREEN_WIDTH + (SCREEN_WIDTH/2);
	GsSortFastSprite( &right_screen, &world_ordering_table[output_buffer_index], 0 );
...
//--------------------------------------------------------------------------
// Function: Scroll()
// Description: Decrement scroll counter to move image left and wrap around
// Parameters: none
// Returns: none
// Notes: N/A
//--------------------------------------------------------------------------
...
void Scroll( void )
 {
	...
	if( scroll_counter <= -SCREEN_WIDTH )
	    scroll_counter = 0;
