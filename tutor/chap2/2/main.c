...
// Author: George Bain
// Date: July 8, 1998
// Description: Chapter 2: Graphics Example 2 - Double Buffer
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Graphics Example 2 - Double Buffer
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		 ...
		 FntPrint(fnt_id[0], "~c900 Graphics Example 2 - Double Buffer ");
