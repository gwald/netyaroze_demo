...
// Author: George Bain
// Date: July 10, 1998
// Description: Chapter 2: Graphic Example 5 - Open, Display 8-bit TIM
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Graphic Example 5 - Open, Display 8-bit TIM
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		...
		FntPrint(fnt_id[0], "~c900 Graphic Example 5 - Open, Display 8-bit TIM in Hi-Res ");		 
