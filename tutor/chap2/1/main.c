...
// Author: George Bain
// Date: July 8, 1998
// Description: Chapter 2: Graphics Example 1 - A Generic Game Application
...
//--------------------------------------------------------------------------
// Function: main()
// Description: Graphics Example 1 - A Generic Game Application
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
    ...
    while( !DONE )
      {
		 ...
		 FntPrint(fnt_id[0], "~c900 Graphics Example 1 \n - A Generic Game Application ");
