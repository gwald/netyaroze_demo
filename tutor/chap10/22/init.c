...
// Parameters: void
// Returns: void
// Notes:- WORLD is the parent coordinate system of object 1 
//       - object 1 is the parent of object 2
//       - object 2 is the parent of object 3
//--------------------------------------------------------------------------
...
void InitCoordinates( void )			
 { 	
   ...
   GsInitCoordinate2(WORLD,&coord_obj[0]);    
   GsInitCoordinate2(&coord_obj[0],&coord_obj[1]);
   GsInitCoordinate2(&coord_obj[1],&coord_obj[2]);
           
   sv_obj[0].vx=sv_obj[0].vy=sv_obj[0].vz=0; 
   sv_obj[1] = sv_obj[2] = sv_obj[0];
