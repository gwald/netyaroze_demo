...
#define OBJECT2_ADDR  (0x80093000)	 // top address of texture data
#define OBJECT3_ADDR  (0x80096000)	 // top address of texture data
#define SPRITE_ADDR   (0x80099000)	 // top address of texture data
...
extern GsDOBJ2 obj[3];								 // 3D object handler
extern GsCOORDINATE2 coord_obj[3];					 // 3D object coordinate handler
extern SVECTOR sv_obj[3];								 // vector for 3D object
