...
// Author: George Bain
// Date: March 1999 
// Description: Automatic Division
...
//--------------------------------------------------------------------------
// Function: main()
// Description: A cube is displayed with the subdivison attribute set ON.
//              To toggle between subdivison or normal use the start and
//              select buttons.
// Parameters: none
// Returns: int
// Notes: Subdivision can slow down your application if set too high!
//--------------------------------------------------------------------------
...
int main( void )
 {
    ...
    while( !DONE )
      {	 		 	     
 		 FntPrint("~c009Automatic Division~c999 \n\n");
