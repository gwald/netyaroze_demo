...
#define OBJECT2_ADDR   (0x80091000)	 // top address of texture data
#define SPRITE_ADDR   (0x80092000)	 // top address of texture data
#define TEX_ADDR      (0x80098000)	 // top address of texture data
...
extern GsDOBJ2 obj2;								 // 3D object handler
extern GsCOORDINATE2 coord_obj2;					 // 3D object coordinate handler
extern SVECTOR sv_obj2;								 // vector for 3D object
