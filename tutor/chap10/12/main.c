...
//--------------------------------------------------------------------------
// Function: main()
// Description: Fogging is used to give a dungeon type look.  The dqa and dqb
//              parameters effect the fogging distance.
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
...
int main( void )
 {
	...
	coord_obj.coord.t[0] = 575;
	coord_obj.coord.t[1] = -1500;
	coord_obj.coord.t[2] = -2200;
