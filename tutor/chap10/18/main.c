...
// Author: George Bain
// Date: March 1999 
// Description: Light source calculation
...
//--------------------------------------------------------------------------
// Function: main()
// Description: A cube is displayed with the Light source calculation attribute 
//              set ON.
//              To toggle between Light source calculation or normal use the 
...
int main( void )
 {
    ...
    while( !DONE )
      {	 		 	     
 		 FntPrint("~c009Light source calculation~c999 \n\n");
         ...
         if( obj.attribute == (1<<6) )
			 FntPrint("~c909\nLight calculation ON~c999 \n\n");
		 else
  			 FntPrint("~c909\nLight calculation OFF~c999 \n\n");
