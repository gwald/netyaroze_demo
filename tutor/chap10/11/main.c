...
int ambient = ONE;							 // ambient lighting


//--------------------------------------------------------------------------
// Function: main()
// Description:	Four values are selected via button presses to demonstrate
//              ambient lighting.
//
...
int main( void )
 {
    ...
    while( !DONE )
      {	 		 	     
 		 FntPrint("~c009Ambient Lighting~c999 \n\n");
		 FntPrint("Loc x:(%d) \n",coord_obj.coord.t[0]);
		 FntPrint("Loc y:(%d) \n",coord_obj.coord.t[1]);
		 FntPrint("Loc z:(%d) \n\n",coord_obj.coord.t[2]);
		 ...
		 switch(ambient)
		   {
		     case 1024:
				FntPrint("\n~c909Ambient Light value: 1/4~c999 \n");
			 break;
			 case 2048:
				FntPrint("\n~c909Ambient Light value: 2/4~c999 \n");
			 break;
			 case 3072:
				FntPrint("\n~c909Ambient Light value: 3/4~c999 \n");
			 break;
			 case ONE:
				FntPrint("\n~c909Ambient Light value: 4/4~c999 \n");			 
			 break;
		   }// end
...
void ControlObject( void )
 {
     ...
     if( PAD_PRESS(buffer1,PAD_R2) )
	   { 
	     // 3072
	     GsSetAmbient( (ONE*3)/4, (ONE*3)/4, (ONE*3)/4 );
	     ambient=3072;   
	   }
