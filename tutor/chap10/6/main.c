...
//--------------------------------------------------------------------------
// Function: main()
// Description: 3D object is loaded and displayed.  Translation of the X, Y,
//              and Z planes are adjusted via button presses.
//         
//              UpdateCoordinates() updates the translation and therefore the
//              3D coordinates of the model in 32-bit 3D space.
// Parameters: none
// Returns: int
// Notes: N/A
//--------------------------------------------------------------------------
