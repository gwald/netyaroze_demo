...
void InitialiseView (void)
{
	...
	LocalAngle.vy = 0;
	LocalAngle.vz = 0;
	ViewingPointDistance = -2000;
	ReferencePointDistance = 500;
#endif
...
#if 0		// OLD: uses WORLD as super, new version uses object itself
	MATRIX tempMatrix;
	VECTOR displacement;		
...
void DealWithLocalView (void)
{
	...
	displacement2.vz = ReferencePointDistance * LocalAngle.vz;			
		...
		// hence position viewpoint 
	TheMainView.vpx = displacement1.vx;
	TheMainView.vpy = displacement1.vy;
	TheMainView.vpz = displacement1.vz;

		// and reference point 
	TheMainView.vrx = displacement2.vx;
	TheMainView.vry = displacement2.vy;
	TheMainView.vrz = displacement2.vz;

		// register change in view
	ViewChanged = TRUE;
#endif		// NEWER, STILL TOO OLD
