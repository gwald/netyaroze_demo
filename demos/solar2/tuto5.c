...
{	
...
#if 0		// OLD: still gives world-relative rotations
	MulMatrix0(&xMatrix, &GlobalMatrix, &copy);
	MulMatrix0(&yMatrix, &copy, &GlobalMatrix);
	MulMatrix0(&zMatrix, &GlobalMatrix, &copy);
#endif
	...
	// position sets position absolutely
	// eg
