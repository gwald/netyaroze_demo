...
#define TMD 0
#define SPRITE 1
#define SPECIAL_SPRITE 2


#define MAX_OBJECTS 256

#define MAX_MINI_OBJECTS 2048


	// no object allowed to be displayed on more than three planes
#define MAX_PLANES_PER_OBJECT 3
