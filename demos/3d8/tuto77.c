...
void InitialiseCubes (void)
{
	...
	CreateCube ( &AllCubes[0], INSIDE_CUBE, 400, VISIBLE_FROM_OUTSIDE,
	...
	CreateCube ( &AllCubes[1], OUTSIDE_CUBE, 5000, VISIBLE_FROM_INSIDE,
	...
	setRECT( &singleOutsideCubeTexture,
			...
			Wave2TextureInfo.pw,
			Wave2TextureInfo.ph);
	CreateCube ( &AllCubes[1], OUTSIDE_CUBE, 5000, VISIBLE_FROM_INSIDE, 4,
...
void HandlePlayersSprite (ObjectHandler *object)
{
	...
	//drawing: SHOULD sort more than one sprite

	object->sprite.x = object->px - (object->sprite.w/2);
	object->sprite.x = object->py - (object->sprite.h/2);
	object->sprite.rotate = object->pAngle;
}	
