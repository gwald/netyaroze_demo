...
void InitialiseObjects (void)
{
	...
	for (i = 0; i < MAX_OBJECTS; i++)
		...
		ObjectArray[i].scaleX = 1;
		ObjectArray[i].scaleY = 1;
		ObjectArray[i].scaleZ = 1;
	   
			// start off stationary with no momentum
		ObjectArray[i].position.vx = 0;
		ObjectArray[i].position.vy = 0;
		ObjectArray[i].position.vz = 0;
		ObjectArray[i].velocity.vx = 0;
		ObjectArray[i].velocity.vy = 0;
		ObjectArray[i].velocity.vz = 0;
	...
	PlayersCube.scaleX = 2;
	PlayersCube.scaleY = 2;
	PlayersCube.scaleZ = 2;

		// start off stationary with no momentum
	PlayersCube.position.vx = 0;
	PlayersCube.position.vy = 0;
	PlayersCube.position.vz = 0;
	PlayersCube.velocity.vx = 0;
	PlayersCube.velocity.vy = 0;
	PlayersCube.velocity.vz = 0;
	...
	/****
	PlayersCube.scaleX = 0.5;
	PlayersCube.scaleY = 0.5;
	PlayersCube.scaleZ = 0.5;
	****/
}
...
void InitialiseModels (void)
{
	...
	for (i = 0; i < MAX_OBJECTS; i++)
		...
		LinkObjectHandlerToTmdObject( &(ObjectArray[i].handler), 
			...
			// Used to be: i, SPHERE_MODEL_ADDRESS
...
void SetUpSolarSystem (void)
{
	...
	ObjectArray[1].position.vx += 2 * ORBIT_SIZE;
	...
	ObjectArray[2].radius = ORBIT_SIZE;
		...
		// move planet away from sun	
	ObjectArray[2].position.vx += ORBIT_SIZE;
}
