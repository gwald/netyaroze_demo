...
#define dumpCOORD2(coord2)																					\
			...
			printf("GsCOORDINATE2: coord.m: [0]: %d, %d, %d\n[1]: %d, %d, %d\n[2]: %d, %d, %d\n",			\
			...
			printf("GsCOORDINATE2: coord.t: %d %d %d\n", 										 			\
					(coord2)->coord.t[0], (coord2)->coord.t[1], (coord2)->coord.t[2]),						\
			printf("GsCOORDINATE2: super pointer: %d\n", (coord2)->super)



#define dumpOBJ2(obj2)													\
			printf("GsDOBJ2: attribute %d\n", (obj2)->attribute),		\
			printf("GsDOBJ2: coord pointer %d\n", (obj2)->coord2),		\
			printf("GsDOBJ2: tmd pointer %d\n", (obj2)->tmd),			\
			printf("GsDOBJ2: id %d\n", (obj2)->id)						
...
#define dumpSPRITE(sprite)													\
			printf("GsSPRITE: attribute %d\n", (sprite)->attribute),		\
			printf("GsSPRITE: x %x, y %d, w %d, h %d\n", 					\
