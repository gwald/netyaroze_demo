...
// SEE tuto1.c for example of this working properly;
// with prettier textures, can be very nice
...
void main (void)
{
	...
	for	(;;)
		...
		setRECT(&GsDRAWENV.clip, 640, 0, 256, 256);
		GsDRAWENV.ofs[0] = 640;
		GsDRAWENV.ofs[1] = 0;
...
{	
	...
	LinkSpriteToImageInfo ( &TheSprite, &TileTextureInfo);
