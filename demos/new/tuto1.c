...
void HandleAllMiniObjects (void);
...
void main (void)
{
	...
	while (QuitFlag == FALSE)
...
#if 0		// use DrawTheTunnel instead
		...
		if (frameNumber == 60)
			maxHsync = hsync;
		else if (maxHsync > 600)		// pause held down		
			maxHsync = 0;
...
#if 0		// strange bug: 
			// tunnel.c assertion (TheView.super == &TheShip.coord) failed
	printf("END iseView: test %d\n",
		 (TheView.super == &TheShip.coord) );
#endif
}
...
#if 1	   // twist round to face the right way
...
#if 0
		// bounds on velocity
	if (TheShip.velocity.vz > 0)	// no going backwards
		TheShip.velocity.vz = 0;
	if (TheShip.velocity.vz < -SHIP_MAXIMUM_SPEED)
		TheShip.velocity.vz = -SHIP_MAXIMUM_SPEED;
#endif
...
void HandleAllObjects (void)
{
	...
	HandleAllMiniObjects();		// DUMMY CALL 
	...
	// NULL FUNCTION
	// since mini objects require no handling at present
void HandleAllMiniObjects (void)
{
}
...
void PrintDataTypeSizes (void)
{
	...
	printf("\n\n\nPrinting Data Type Sizes\n\n");

	printf("ObjectHandler: %d\n", sizeof(temp1) );
	printf("MiniObject: %d\n", sizeof(temp2) );
	printf("TunnelSection: %d\n", sizeof(temp3) );
	printf("VECTOR: %d\n", sizeof(temp4) );
	printf("SVECTOR: %d\n", sizeof(temp5) );
	printf("MATRIX: %d\n", sizeof(temp6) );
	printf("GsCOORDINATE2: %d\n", sizeof(temp7) );
	printf("GsDOBJ2: %d\n", sizeof(temp8) );
	printf("GsIMAGE: %d\n", sizeof(temp9) );
	printf("GsSPRITE: %d\n", sizeof(temp10) );
