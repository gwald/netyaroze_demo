...
void PrintCompassDirectionToNearestEnemy (int direction)
{
	...
	// given an object moving via UpdateObjectCoordinates
	// (i.e. move and rotate w.r.t. self)
	// this gets direction-object-points-in as a vector;
	// hence can get X and Y axes (object-local)
void GetZAxisFromMatrix (MATRIX* matrix, VECTOR* vector)
{
