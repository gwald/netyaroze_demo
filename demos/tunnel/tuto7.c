...
void DealWithControllerPad (void)
{
	...
	if (pad & PADR2)		 // sound check
		...
		if (pad & PADLleft)
			{
			TurnOnSound (27, 0, 10, 10, 127, 127);
			}
		if (pad & PADLright)
			{
			TurnOnSound (31, 0, 10, 10, 127, 127);
			}
		if (pad & PADLup)
			{
			TurnOnSound (47, 0, 10, 10, 127, 127);
			}
		if (pad & PADLdown)
			{
			TurnOnSound (53, 0, 10, 10, 127, 127);
			}
		if (pad & PADRleft)
			{
			TurnOnSound (55, 0, 10, 10, 127, 127);
			}
		if (pad & PADRright)
			{
			TurnOnSound (106, 0, 10, 10, 127, 127);
			}
		if (pad & PADRup)
			{
			TurnOnSound (127, 0, 10, 10, 127, 127);
			}
		return;
		}
#endif
