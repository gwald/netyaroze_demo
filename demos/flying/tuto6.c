			...
			if (ObjectArray[i]->alive == TRUE)
				...
				switch(object->type)
					...
					case PLAYER:
						...
						KeepWithinRange(object->position.vx, 0, WORLD_MAX_X * FACT);
						KeepWithinRange(object->position.vy, 0, WORLD_MAX_Y * FACT);
						KeepWithinRange(object->position.vz, 0, WORLD_MAX_Z * FACT);
